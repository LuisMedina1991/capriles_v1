    ...
    <div class="col-sm-12">
        <div class="widget widget-chart-one">
            <div class="widget-heading">
                ...
                <div class="row mr-5">
                    <div class="col-sm-6">
                        <h5 class="text-uppercase">deuda total con proveedores:
                            ${{number_format($debts->sum('amount'),2)}}</h5>
                    </div>
                    <div class="col-sm-6">
                        <a href="{{ url('suppliers_report/pdf' . '/' . $debts->sum('amount') . '/' . $search_2 . '/' . $search) }}" 
                        class="btn btn-dark btn-block {{count($debts) < 1 ? 'disabled' : ''}}"
                ...
                {{--<div class="form-inline">
                    <ul class="mr-5">
                        <h5 class="text-uppercase">
                            deuda total con proveedores: ${{number_format($debts->sum('amount'),2)}}
                        </h5>
                        <br>
                ...
                <div class="container">
                    <div class="row row-cols-2">
                        <div class="col">
                            <h5 class="text-uppercase">
                                deuda total: ${{number_format($debts->sum('amount'),2)}}
                            </h5>
                        </div>
                        <div class="col">
                    ...
                    <table class="table table-striped table-bordered mt-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 class="text-center text-uppercase">{{$debt->income->file_number}}</h6>
                                </td>
                                <td>
                                    <h6 class="text-center text-uppercase">{{$debt->supplier->name}}</h6>
                                </td>
                                <td>
                                    <h6 class="text-center text-uppercase">{{$debt->description}}</h6>
                                </td>
                                <td>
