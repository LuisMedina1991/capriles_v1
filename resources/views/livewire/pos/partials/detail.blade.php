                    ...
                    <table class="table table-bordered table-striped mt-1"> <!--tabla-->
                        ...
                        <tbody> <!--cuerpo de tabla-->                        
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <!--evento onclick de js hace llamado a la funcion confirm de js-->
                                    <!--en este caso la funcion Confirm recibe (id,accion/metodo,mensaje)-->
