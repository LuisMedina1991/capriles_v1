<div class="row sales layout-top-spacing">
    <div class="col-sm-12">
        <div class="widget widget-chart-one">
            <div class="widget-heading">
                ...
                <div class="row mr-5">
                    <div class="col-sm-6">
                        <h5 class="text-uppercase">deuda total de clientes:
                            ${{number_format($debts->sum('amount'),2)}}</h5>
                    </div>
                    <div class="col-sm-6">
                        <a href="{{ url('customers_report/pdf' . '/' . $debts->sum('amount') . '/' . $search_2 . '/' . $search) }}" 
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center">
                                    <h6>{{Carbon\Carbon::parse($debt->created_at)->format('d-m-Y')}}</h6>
                                </td>
                                <td>
                                    <h6 class="text-center text-uppercase">{{$debt->sale->file_number}}</h6>
                                </td>
                                <td>
                                    <h6 class="text-center text-uppercase">{{$debt->customer->name}}</h6>
                                </td>
                                <td>
    ...
    @include('livewire.customer_debts.details')
