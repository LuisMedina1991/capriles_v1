<ul class="navbar-item flex-row search-ul">
    <li class="nav-item align-self-center search-animated">
        ...
        <form class="form-inline search-full form-inline search" role="search">
            <div class="search-bar">
                ...
                <input id="code" type="text" wire:keydown.enter.prevent="$emit('scan-code', $('#code').val(),$('#sale_price').val(),$('#office').val())" 
    ...
    <li class="nav-item align-self-center search-animated">
        <form class="form-inline search-full form-inline search">
            <div class="search-bar">
                <input id="sale_price" type="text" data-type="currency" wire.model="sale_price" class="form-control search-form-control ml-lg-auto text-center" placeholder="Precio de venta...">
            </div>
        </form>
    </li>
    <li>
