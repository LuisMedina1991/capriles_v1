    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" wire:model.lazy="name" class="form-control component-name" placeholder="Nombre del cliente...">
                            </div>
                            @error('name')
            ...
            <div class="modal-footer">
                <button type="button" wire:click.prevent="StoreCustomer()" class="btn btn-dark close-modal">GUARDAR</button>
                <button type="button" wire:click.prevent="CloseCustomerModal()" class="btn btn-dark close-btn text-info" data-dismiss="modal">CERRAR</button>
            </div>
        </div>
    </div>
</div>