...
<body>
    <header>
        <table width="100%">
            ...
            <tr>
                <td class="text-center">
                    <span style="font-size: 20px; font-weigth: bold;">Deudas de Clientes</span>
                </td>
            </tr>
            <tr>
                <td class="text-center">
                    <span style="font-size: 16px"><strong>DEUDA TOTAL DE CLIENTES: ${{ number_format($total,2)
                            }}</strong></span>
                    <br>
        ...
        <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center">
                        <h6 class="text-center">{{$debt->sale->file_number}}</h6>
                    </td>
                    <td align="center">
                        <h6 class="text-center">{{$debt->customer->name}}</h6>
                    </td>
                    <td align="center">
