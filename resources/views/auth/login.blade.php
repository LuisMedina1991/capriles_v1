        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center" style="background: #3B3F5C">
            ...
            <div class="social-line">
              ...
              <a href="https://twitter.com/LlantasCapriles" class="btn btn-just-icon btn-link btn-white">
                <i class="fa fa-twitter"></i>
              </a>
              <a href="https://www.instagram.com/ventasimportadoracapriles/?hl=es-la" class="btn btn-just-icon btn-link btn-white">
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-dark btn-lg">{{ __('Ingresar') }}</button>
          </div>
        </div>
      </form>
      <div class="row">
